...
docker compose up -d
```
When container starts up, database should be available on localhost:5432 with default db (*fts*), username(*user*) and password(*password*).

Base tables and data installed with initial scripts: 
